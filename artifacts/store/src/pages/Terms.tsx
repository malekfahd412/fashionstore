...
export default function Terms() {
  ...
  const sections = [
    { en: { title: "Acceptance of Terms", body: "By accessing or using LUXE, you agree to be bound by these Terms and Conditions and our Privacy Policy. If you do not agree, please do not use our service." }, ar: { title: "قبول الشروط", body: "باستخدام LUXE، فإنك توافق على الالتزام بهذه الشروط والأحكام وسياسة الخصوصية. إذا لم توافق، يرجى عدم استخدام خدمتنا." } },
    ...
    { en: { title: "Intellectual Property", body: "All content on LUXE — including text, images, logos, and software — is the property of LUXE or its content suppliers and is protected by intellectual property laws." }, ar: { title: "الملكية الفكرية", body: "جميع المحتوى على LUXE — بما في ذلك النصوص والصور والشعارات والبرامج — هو ملك لـ LUXE أو موردي المحتوى الخاصين بها ومحمي بموجب قوانين الملكية الفكرية." } },
    { en: { title: "Limitation of Liability", body: "LUXE shall not be liable for any indirect, incidental, or consequential damages arising from your use of our services. Our total liability shall not exceed the amount paid for the order in question." }, ar: { title: "حدود المسؤولية", body: "لن تكون LUXE مسؤولة عن أي أضرار غير مباشرة أو عرضية أو تبعية ناشئة عن استخدامك لخدماتنا. لن تتجاوز مسؤوليتنا الإجمالية المبلغ المدفوع عن الطلب المعني." } },
