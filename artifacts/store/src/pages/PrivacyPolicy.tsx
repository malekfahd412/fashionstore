...
export default function PrivacyPolicy() {
  ...
  const sections = [
    ...
    { en: { title: "Your Rights", body: "You have the right to access, correct, or delete your personal data. You may also opt out of marketing emails at any time. Contact us at privacy@luxefashion.com to exercise these rights." }, ar: { title: "حقوقك", body: "لديك الحق في الوصول إلى بياناتك الشخصية أو تصحيحها أو حذفها. يمكنك أيضاً إلغاء الاشتراك في رسائل البريد الإلكتروني التسويقية في أي وقت. تواصل معنا على privacy@luxefashion.com لممارسة هذه الحقوق." } },
